...
<details>
<summary>reflow, repaint</summary>
...
- 동작 방식
    ...
    - 서버가 쿠키를 통해 발급해 준 세션 ID를 클라이언트가 저장
    - 클라이언트가 서버에 요청 시 세션 ID를 전달, 서버에서는 전달받은 세션 ID로 세션 정보를 조회
</details>
...
<details>
<summary>hydration 오류 발생</summary>
