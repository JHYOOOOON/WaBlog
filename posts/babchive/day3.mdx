...
date: "2022.04.08"
thumbnailUrl: "/static/images/babchive/day3/20220407.jpg"
---

<div align="center">
	<img src="/static/images/babchive/day3/20220407.jpg" width="300px" alt="벚꽃" />
</div>
...
<div align="center">
	<img src="/static/images/babchive/day3/20220408.jpg" width="300px" alt="버즈라이브" />
</div>
...
function App() {
	...
	useEffect(() => { console.log(inputRef, ":::inputRef") }, []);
	return (
		<div className="App">
...
<div align="center">
	<img src="/static/images/babchive/day3/example.png" width="1000px" alt="시연" />
</div>
